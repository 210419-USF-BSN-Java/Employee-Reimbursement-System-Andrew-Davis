...
public class EmployeePostgres implements EmployeeDao {
	...
	public User getById(Integer u_id) {
		...
		String sql = "SELECT * FROM ers_users WHERE ers_user_id = ? AND user_role_id = 1";
	...
	public Integer delete(User u) {
		// DELETE ONE
        String sql = "DELETE FROM ers_users WHERE ers_user_id = ? AND user_role_id = 1";
